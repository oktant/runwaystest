                    ...
                    <div class="col-lg-12">
                        <div class="box dark">
                            ...
                            <div id="div-1" class="body">
                                <form class="form-horizontal" action="queryCountryRequest" method="GET">

                                    <div class="form-group">
                                        <label class="control-label col-lg-2">Country Name or Code</label>
                                        <div class="col-lg-8">

                                            <input style="width:50%" type="text" id="countryNameOrCode"
                                                   class="form-control" name="countryNameOrCode">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div>
                                <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                    <c:forEach items="${cnoc}" var="element">
                                        <tr>
                                            <td><c:out value="${element.countryName}" /></td>
                                            <td><c:out value="${element.countryCode}" /></td>
                                            <td><c:out value="${element.type}" /></td>
                                            <td><c:out value="${element.name}" /></td>
                                            <td><c:out value="${element.latitude_deg}" /></td>
                                            <td><c:out value="${element.longitude_deg}" /></td>
                                            <td><c:out value="${element.elevation}" /></td>
                                            <td><c:out value="${element.municipality}" /></td>
                                            <td><c:out value="${element.surface}" /></td>
                                            <td><c:out value="${element.le_ident}" /></td>
                                            <td><c:out value="${element.closed}" /></td>
